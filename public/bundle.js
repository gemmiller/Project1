...
/***/ function(module, exports, __webpack_require__) {
	...
	var DrawingSpace = __webpack_require__(5);

	//Data====================================================
	var navlinks = __webpack_require__(1);
	var sections = __webpack_require__(2);
	...
	//Render Sidebar
	React.render(React.createElement(Sidebar, {sections: sections}),document.getElementById('sidebar'));

	//Render DrawingSpace
	React.render(React.createElement(DrawingSpace, null),document.getElementById('drawingSpace'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navbar = React.createClass({displayName: "Navbar",
	    render:function(){
	        var navlinks = this.props.navData.map(function (link) {
	            return(
	                React.createElement("li", null, React.createElement("a", {href: link.href}, link.displayName))
	                );
	        });
	        return(
	...
	var CollapsedNavButton = React.createClass({displayName: "CollapsedNavButton",
	    render: function(){
	        return(
	...
	var ProjectName = React.createClass({displayName: "ProjectName",
	    render: function(){
	        return(
	            React.createElement("a", {className: "navbar-brand", href: "#"}, this.props.projectName)
	            );
	    }
	});
	    ...
	    render: function(){
	        return(
	            React.createElement("div", {className: "navbar-header"}, 
	             React.createElement(CollapsedNavButton, null), 
	             React.createElement(ProjectName, {projectName: this.props.projectName})
	            )
	            );
	    }
	});
	        ...
	        return(
	            React.createElement("nav", {className: "navbar navbar-inverse navbar-fixed-top"}, 
	             React.createElement("div", {className: "container-fluid"}, 
	                 React.createElement(NavbarHeader, {projectName: this.props.projectName}), 
	                 React.createElement(Navbar, {navData: this.props.navData})
	             )
	            )
	            );
	    }
	...
	var Sidebar = React.createClass({displayName: "Sidebar",
	    render:function(){
	       ...
	       return(
	            ...
	            React.createElement("div", {id: "sidebar", className: "col-sm-3 col-md-2 sidebar"}, 
	                sections
	           )
	       );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	//Libraries========================================================
	var React = __webpack_require__(9);
	var fabric = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!/home/gemmiller/git/project1/node_modules/css-loader/index.js!/home/gemmiller/git/project1/public/css/dashboard.css", function() {
			var newContent = require("!!/home/gemmiller/git/project1/node_modules/css-loader/index.js!/home/gemmiller/git/project1/public/css/dashboard.css");
